...
if not st.session_state.chat_history:
    st.markdown("<p style='color:#3a5a70;font-size:0.75rem;font-family:DM Mono,monospace;margin-bottom:6px;'>Try asking:</p>", unsafe_allow_html=True)
    suggestions = [
...
if (send or user_input) and str(user_input).strip():
    ...
    with st.spinner("🔍 Thinking…"):
        ...
        try:
            # Pass only last 10 messages to avoid context bloat causing loops
